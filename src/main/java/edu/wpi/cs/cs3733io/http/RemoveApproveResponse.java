...
public class RemoveApproveResponse {

	public String response;
	public int statusCode; // HTTP status code.
	public String error;

	public RemoveApproveResponse (String value, int statusCode) {
			this.response = "" + value; // doesn't matter since error
			this.statusCode = statusCode;
			this.error = "";
		}

	public RemoveApproveResponse (int statusCode, String errorMessage) {
