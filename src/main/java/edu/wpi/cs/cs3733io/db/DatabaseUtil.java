...
public class DatabaseUtil {
	...
	// DB user names and passwords (as well as the db endpoint) should never be
	// stored directly in code.
	//
	// https://docs.aws.amazon.com/lambda/latest/dg/env_variables.html
	//
	// The above link shows how to ensure Lambda function has access to environment
	// as well as local
	...
	protected static Connection connect() throws Exception {
		...
		try {
			...
			System.err.println(
					"DB-ERROR:" + schemaName + "," + dbUsername + "," + dbPassword + "," + rdsMySqlDatabaseUrl);
